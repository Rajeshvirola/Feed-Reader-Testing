...
# Feed Reader Testing - Front-End Nanodegree Project

In this project we are given web based application that content RSS feeds by Udacity. The tests are attached with Jasmine (javascript framework) to check functionalities of the code.
